        ...
        <section id="main_section">
            ...
            <article id="section_article2">
                <?php
                    ...
                    if($_POST["password"]==$query_data[1])
                    {
                        echo "<form METHOD='post'  ACTION='modifyInformation3.php' class='loginBox'>";

                        echo "<label for'password'>수정할 비밀번호</label><br>";
                        echo "<input id='password' name='password' type='text' value=$query_data[1] style='margin-bottom:10px;width:100%'><br>";

                        echo "<label for'name'>수정할 이름</label><br>";
                        echo "<input id='name' name='name' type='text' value=$query_data[2] style='margin-bottom:10px;width:100%'><br>";

                        echo "<label for'mobile'>수정할 전화번호</label><br>";
                        echo "<input id='mobile' name='mobile' type='text' value=$query_data[3] style='margin-bottom:10px;width:100%'><br>";

                        echo "<label for'nick'>수정할 닉네임</label><br>";
                        echo "<input id='nick' name='nick' type='text' value=$query_data[4] style='margin-bottom:10px;width:100%'><br>";
