   ...
   .sidenav {
    ...
    <body>
        ...
        <section id="main_section">
            ...
            <article id="section_article2" class='loginBox'>
                <FORM METHOD="post"  ACTION="join_result.php">
                    <label for="ID" >아이디</label><br>
                    <INPUT TYPE ="text" id='ID' NAME="userID" placeholder='아이디를 입력하세요' style='margin-bottom:10px;width:100%'> <br>
                    <label for="PW" >비밀번호</label><br>
                    <INPUT TYPE ="password" id='PW' NAME="userPW" placeholder='비밀번호를 입력하세요' style='margin-bottom:10px;width:100%'> <br>
                    <label for="name" >이름</label><br>
                    <INPUT TYPE ="text" id='name' NAME="name" placeholder='이름을 입력하세요' style='margin-bottom:10px;width:100%'> <br> 
                    <label for="nick" >닉네임</label><br>
                    <INPUT TYPE ="text" id='nick' NAME="nickname" placeholder='닉네임을 입력하세요' style='margin-bottom:10px;width:100%'> <br> 
                    <label for="phone" >휴대폰번호</label><br>
                    <INPUT TYPE ="text" id='phone' NAME="mobile" placeholder='휴대폰번호를 입력하세요' style='margin-bottom:10px;width:100%'> <br>
                    <BR>
                    <INPUT TYPE="submit"  VALUE="회원 입력" class='backBtn'>
                </FORM>
            </article>
        </section>
