        ...
        <section id="main_section">
            ...
            <article id="section_article2">
                <?php
                    ...
                    $_user_PW=$_POST["password"];
                    $_user_name=$_POST["name"];
                    $_user_mobile=$_POST["mobile"];
                    $_user_nickname=$_POST["nick"];

                    $con=mysqli_connect("localhost", "root", "1234", "prepare") or die("MySQL 접속 실패 !!");
                    $user_id=$_SESSION['ssen'];
                    $sql="UPDATE user SET userPW='$_user_PW' , name='$_user_name' , mobile='$_user_mobile' , nickname='$_user_nickname'  WHERE userID='$user_id'";
