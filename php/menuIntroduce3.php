   ...
   .sidenav {
    ...
    <body>
        ...
        <section id="main_section">
            ...
            <div id="section_header"><h2><b>메뉴 소개</b></h2></div>
            <article id="section_article">
                <div><a href="menuIntroduce.php"><b>충만 치킨</b></a></div>
                <div><a href="menuIntroduce2.php"><b>티꾸닭</b></a></div>
                <div><a href="menuIntroduce3.php"><b>사이드메뉴</b></a></div>
            </article>
            ...
            <article id="section_article2">
                <?php
                    ...
                    $sql="SELECT * FROM menu where kind='사이드메뉴'";
