   ...
   .sidenav {
    ...
    <body>
        ...
        <section id="main_section">
            ...
            <div id="section_header"><h2><b>결재 완료</b></h2></div>
            ...
            <article id="section_article2">
                <?php
                    ...
                    if(isset($_POST['modifyChk'])){
                        ...
                        if (is_array($_POST['modifyChk'])) {
                            echo "<table border='1' class='billTable'>";
                            echo "<tr>";
                            echo "<th colspan=3>영수증</th>";   
                            echo "</tr>";

                            echo "<tr>";
                            echo "<th>구매자</th>";
                            $query_data=mysqli_fetch_row($result);
                            $user_name=$query_data[2];
                            ...
                            foreach($_POST['modifyChk'] as $value){
                                //echo $value;
                                $temp="menu_$value";
                                //echo $temp;
                                //echo $_POST[$temp];
                                ...
                                $userID=$_SESSION["ssen"];
                                $menuID=$value;
                                $amount=$_POST[$temp];
                                $orderDate=date("Y-m-d H:i:s");
                                $banchID=$_POST['branch'];
                                ...
                                echo "banchID=$banchID";*/

                                $sql2 ="INSERT INTO _order VALUES('".$orderNum."','".$userID."','".$menuID."','".$amount."','".$orderDate."','".$banchID."');";
                                ...
                                echo "<tr>";
                                echo "<th>$query_data[1]</th>";
                                echo "<td>$query_data[2]</td>";
                                echo "<td>$amount</td>";
                                echo "</tr>";

                                $sum=$sum+$amount*$query_data[2];
